...
const jannik = {
  ...
  occupation: "IT System Administrator (in training)",
  previousLife: "Plastics and Rubber Technologist",
  
  languages: {
    spoken: ["Deutsch", "Luxemburgisch", "English", "Österreichisch"],
    programming: ["JavaScript", "Lua", "C++", "PHP", "Go", "Python"]
  },
  
  skills: {
    os: ["GNU/Linux 🐧", "FreeBSD"],
    hardware: ["PCB Design", "Embedded Systems", "Networking"],
    tools: ["Docker", "Cloudflare", "Git", "Photoshop"]
  }
}
```
